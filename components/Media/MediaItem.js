...
const MediaItem = ({ data }) => {
    ...
    return <>
        <div className="news-item">
            <Link href={`/media/${data.slug}`} className="news-item-img news-box-image" >
            ...
            <div className="news-item-content">
                <div className="new-news-categories">
                    {data.categories && data.categories[0] && (
                        <div className={`new-news-category`}>
                            <Link href={`/media?category=${data.categories[0].slug}`}>
                ...
                <Link href={`/media/${data.slug}`} className="news-item-title">
