...
import { getFastLinks, getUpBanner } from "lib/getFetchers";
  ...
  return (
    <>
      <section className="section">
        <div className="container costume-container">
          {ads && (
            <div className="ads">
              <a href={ads.link} target="_blank" className="ads-box">
                <img src={base.cdnUrl + "/" + ads.banner} />
              </a>
            </div>
          )}
